          ...
          <div className="mt-12 p-6 bg-gray-50 dark:bg-gray-800/50 rounded-xl">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Average mood today</span>
                <span className="text-lg font-semibold text-gray-900 dark:text-gray-100">3.6</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Total check-ins</span>
                <span className="text-lg font-semibold text-gray-900 dark:text-gray-100">12</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-600 dark:text-gray-400">Last updated</span>
                <span className="text-lg font-semibold text-gray-900 dark:text-gray-100">2 min ago</span>
              </div>
            </div>
          </div>
        </main>
